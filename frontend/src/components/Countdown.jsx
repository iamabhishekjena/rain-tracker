...
const S = {
  ...
  lbl: { fontFamily: "'DM Mono',monospace", fontSize: '.65rem', letterSpacing: '.26em', textTransform: 'uppercase', color: 'rgba(255,255,255,.38)', marginBottom: '.3rem' },
  ...
  num: { fontFamily: "'DM Mono',monospace", fontSize: '1.75rem', fontWeight: 400, color: '#fff', lineHeight: 1, textShadow: '0 2px 12px rgba(0,0,0,.3)' },
  unitLbl: { fontFamily: "'DM Mono',monospace", fontSize: '.56rem', letterSpacing: '.18em', textTransform: 'uppercase', color: 'rgba(255,255,255,.28)', marginTop: 2 },
  ...
  nnLabel: { fontFamily: "'DM Mono',monospace", fontSize: '.56rem', letterSpacing: '.2em', textTransform: 'uppercase', color: 'rgba(255,255,255,.22)' },
  nnDate: { fontFamily: "'Cormorant Garamond',serif", fontSize: '1.35rem', fontStyle: 'italic', color: '#fff' },
};
