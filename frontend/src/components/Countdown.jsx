...
const S = {
  ...
  lbl: { fontFamily: "'DM Mono',monospace", fontSize: '.53rem', letterSpacing: '.26em', textTransform: 'uppercase', color: 'rgba(255,255,255,.38)', marginBottom: '.3rem' },
  ...
  unitLbl: { fontFamily: "'DM Mono',monospace", fontSize: '.44rem', letterSpacing: '.18em', textTransform: 'uppercase', color: 'rgba(255,255,255,.28)', marginTop: 2 },
  ...
  nnLabel: { fontFamily: "'DM Mono',monospace", fontSize: '.44rem', letterSpacing: '.2em', textTransform: 'uppercase', color: 'rgba(255,255,255,.22)' },
