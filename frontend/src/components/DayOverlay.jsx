...
const S = {
  ...
  type:        { fontFamily:"'DM Mono',monospace", fontSize:'.85rem', letterSpacing:'.24em', textTransform:'uppercase', marginBottom:'1.3rem' },
  stats:       { display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'.6rem', marginBottom:'1.3rem' },
  statV:       { fontFamily:"'DM Mono',monospace", fontSize:'1.2rem', color:'#fff' },
  statL:       { fontFamily:"'DM Mono',monospace", fontSize:'.68rem', letterSpacing:'.14em', textTransform:'uppercase', color:'rgba(255,255,255,.28)' },
  hourly:      { marginBottom:'1rem', textAlign:'left' },
  hourlyLabel: { fontFamily:"'DM Mono',monospace", fontSize:'.72rem', letterSpacing:'.2em', textTransform:'uppercase', color:'rgba(255,255,255,.3)', marginBottom:'.4rem' },
  hourlyChips: { display:'flex', flexWrap:'wrap', gap:4 },
  chip:        { display:'inline-flex', alignItems:'center', gap:3, background:'rgba(106,180,255,.12)', border:'.5px solid rgba(106,180,255,.25)', borderRadius:7, padding:'4px 9px', fontFamily:"'DM Mono',monospace", fontSize:'.78rem', color:'#6ab4ff' },
  msg:         { fontFamily:"'Cormorant Garamond',serif", fontSize:'1.4rem', fontStyle:'italic', color:'rgba(255,255,255,.82)', marginBottom:'1.4rem', lineHeight:1.55 },
  back:        { background:'rgba(255,255,255,.1)', border:'.5px solid rgba(255,255,255,.18)', borderRadius:100, color:'#fff', fontFamily:"'DM Mono',monospace", fontSize:'.85rem', letterSpacing:'.14em', padding:'.6rem 1.8rem', cursor:'pointer' },
};
