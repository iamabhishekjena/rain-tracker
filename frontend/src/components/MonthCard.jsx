...
const S = {
  ...
  name: { fontFamily: "'Cormorant Garamond',serif", fontSize: '1.05rem', fontWeight: 300, color: '#fff' },
  badge: { fontFamily: "'DM Mono',monospace", fontSize: '.46rem', letterSpacing: '.08em', background: 'rgba(106,180,255,.13)', color: 'rgba(106,180,255,.88)', border: '.5px solid rgba(106,180,255,.22)', borderRadius: 100, padding: '2px 6px' },
  ...
  dayHeader: { fontFamily: "'DM Mono',monospace", fontSize: '.4rem', textAlign: 'center', color: 'rgba(255,255,255,.22)', padding: '1px 0' },
  dot: { aspectRatio: '1', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'DM Mono',monospace", fontSize: '.4rem', cursor: 'pointer', transition: 'transform .2s' },
