...
const S = {
  ...
  name: { fontFamily: "'Playfair Display',serif", fontSize: '1.35rem', fontWeight: 300, color: '#fff' },
  badge: { fontFamily: "'Inter',sans-serif", fontSize: '.68rem', letterSpacing: '.08em', background: 'rgba(106,180,255,.13)', color: 'rgba(106,180,255,.88)', border: '.5px solid rgba(106,180,255,.22)', borderRadius: 100, padding: '2px 6px' },
  ...
  dayHeader: { fontFamily: "'Inter',sans-serif", fontSize: '.62rem', textAlign: 'center', color: 'rgba(255,255,255,.22)', padding: '1px 0' },
  dot: { aspectRatio: '1', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Inter',sans-serif", fontSize: '.62rem', cursor: 'pointer', transition: 'transform .2s' },
