...
const S = {
  ...
  chartLegend:  { display:'flex', gap:'1.2rem', justifyContent:'flex-end', marginTop:'.35rem', fontFamily:"'DM Mono',monospace", fontSize:'.58rem', letterSpacing:'.08em' },
  ...
  statValue:    { fontFamily:"'DM Mono',monospace", fontSize:'1.05rem', fontWeight:400, color:'#fff', lineHeight:1 },
  statLabel:    { fontFamily:"'DM Mono',monospace", fontSize:'.54rem', letterSpacing:'.12em', textTransform:'uppercase', color:'rgba(255,255,255,.3)', marginTop:2 },
  statSub:      { fontFamily:"'DM Mono',monospace", fontSize:'.56rem', color:'rgba(255,255,255,.4)', marginTop:1 },
  ...
  calloutLabel: { fontFamily:"'DM Mono',monospace", fontSize:'.54rem', letterSpacing:'.14em', textTransform:'uppercase', color:'rgba(255,255,255,.35)' },
  calloutDate:  { fontFamily:"'Outfit',sans-serif", fontSize:'.85rem', color:'rgba(255,255,255,.8)', whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis' },
  calloutValue: { fontFamily:"'DM Mono',monospace", fontSize:'1rem', color:'#fff', flexShrink:0 },

  fullCal:      { display:'grid', gridTemplateColumns:'repeat(7,1fr)', gap:4 },
  fh:           { fontFamily:"'DM Mono',monospace", fontSize:'.62rem', textAlign:'center', color:'rgba(255,255,255,.28)', padding:'3px 0', letterSpacing:'.04em' },
  ...
  fdIcon:       { fontSize:'1rem', lineHeight:1 },
  fdNum:        { fontFamily:"'DM Mono',monospace", fontSize:'.62rem', color:'rgba(255,255,255,.55)', lineHeight:1 },
  fdPrecip:     { fontFamily:"'DM Mono',monospace", fontSize:'.5rem', lineHeight:1, marginTop:1 },
};
