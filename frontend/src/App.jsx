...
const S = {
  ...
  input:      { background:'rgba(255,255,255,.09)', backdropFilter:'blur(20px)', WebkitBackdropFilter:'blur(20px)', border:'.5px solid rgba(255,255,255,.18)', borderRadius:100, color:'#fff', fontFamily:"'DM Mono',monospace", fontSize:'.68rem', letterSpacing:'.08em', padding:'.48rem 1.2rem', outline:'none', width:220 },
  ...
  sugName:    { fontFamily:"'Outfit',sans-serif", fontSize:'.85rem', color:'#fff', whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis' },
  sugMeta:    { fontFamily:"'DM Mono',monospace", fontSize:'.52rem', color:'rgba(255,255,255,.38)', whiteSpace:'nowrap', flexShrink:0 },
